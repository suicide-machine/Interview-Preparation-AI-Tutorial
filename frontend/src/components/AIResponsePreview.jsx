          ...
          components={{
            code({ node, className, children, ...props }) {
              ...
              return !isInline ? (
                ...
                <code
                  className="px-1 py-0.5 bg-gray-100 rounded text-lg"
                  {...props}
                >
                  {children}
                </code>
            ...
            h4({ children }) {
              return (
                <h4 className="text-base font-bold mt-6 mb-4">{children}</h4>
              )
            },
    ...
    <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
      <div className="flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray-200">
        ...
        >
          ...
          {copied && (
            <span className="absolute -top-8 right-0 bg-black text-white text-sm rounded-md px-2 py-1 opacity-80 group-hover:opacity-100 transition">
              Copied!
            </span>
          )}
        </button>
